...
export const SkipForwardIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path fillRule="evenodd" d="M4.5 5.653c0-1.426 1.529-2.33 2.779-1.643l7.58 4.347V5.653c0-1.426 1.529-2.33 2.779-1.643l7.58 4.347a2 2 0 010 3.286l-7.58 4.347c-1.25.717-2.779-.217-2.779-1.643v-4.347l-7.58 4.347c-1.25.717-2.779-.217-2.779-1.643V5.653z" clipRule="evenodd" />
    </svg>
);
...
export const SkipBackIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path fillRule="evenodd" d="M19.5 5.653c0-1.426-1.529-2.33-2.779-1.643l-7.58 4.347V5.653c0-1.426-1.529-2.33-2.779-1.643L-1.158 12a2 2 0 000 3.286l7.58 4.347c1.25.717 2.779-.217 2.779-1.643v-4.347l7.58 4.347c1.25.717 2.779-.217 2.779-1.643V5.653z" clipRule="evenodd" />
    </svg>
);
...
export const MusicNoteIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 9l10.5-3m0 6.553v3.75a2.25 2.25 0 01-1.632 2.163l-1.32.377a1.803 1.803 0 11-.99-3.467l2.31-.66a2.25 2.25 0 001.632-2.163zm0 0V7.5a2.25 2.25 0 00-2.25-2.25H5.25A2.25 2.25 0 003 7.5v9.75a2.25 2.25 0 002.25 2.25h3.75a2.25 2.25 0 002.25-2.25z" />
    </svg>
);
